...
export default {
  schema: {
    properties: [
      ...
      IATA_COUNTRY_CODE(
        ...
        undefined,
        undefined,
        "The two-character IATA code for the country"
      ),
      LATITUDE(
        undefined,
        true,
  ...
  single: {
    ...
    request: {
      curl: `curl -X GET --compressed "https://api.flyline.io/api/cities/{iata_code}/" \\ 
...
p JSON.parse(result)`
  ...
  list: {
    ...
    request: {
      curl: `curl -X GET --compressed "https://api.flyline.io/api/cities/" \\ 
